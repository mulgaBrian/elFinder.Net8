...
{
  public sealed class RequestCommand(ConnectorCommand cmd)
  {
    public string ReqId { get; set; } = cmd.ReqId;
    public string Cmd { get; set; } = cmd.Cmd;
    public HttpMethod Method { get; set; } = cmd.Method;
    public IReadOnlyDictionary<string, StringValues> RequestHeaders { get; set; } = cmd.RequestHeaders;
    public IReadOnlyDictionary<string, StringValues> Query { get; set; } = cmd.Query;
    public IReadOnlyDictionary<string, StringValues> Form { get; set; } = cmd.Form;
  ...
  public sealed class ConnectorCommand
  {
    ...
    {
      FieldInfo[] constFields = typeof(ConnectorCommand)
